    ...
    return (
        ...
        <header className={`w-16 md:hidden`}>
            <button
                ...
                className={"transition-transform duration-300 ease-in-out md:hidden fixed top-4 left-2 z-30 p-2 rounded-md shadow " + (isOpen ? 'translate-x-42' : '-translate-x-0')}//+ (isOpen?"left-44":"left-4")}
            >
                <svg
            ...
            >
                ...
                {accessToken && username ? (
                    <ul>
                        <NavLink
                            className="w-full flex items-center pl-3 mt-2 focus:bg-indigo-700 focus:border-solid focus:border-indigo-400 focus:border-r-5 hover:bg-indigo-600"
                            to='/account'
                        ...
                        <li
                            className="flex items-center pl-3 mt-2 hover:bg-indigo-600 hover:cursor-pointer"
