...
import {updateValidation, addMoviesValidation} from "../schema/apiSchema.js"
...
async function apiRoutes (fastify, options) {
    ...
    fastify.patch('/users/:id', {preHandler: fastify.authenticate, schema: updateValidation}, userController.modifyInfo)
